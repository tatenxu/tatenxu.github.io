...
!function(c){c.fn.simpleJekyllSearch=function(e){var l=c.extend({jsonFile:"/search.json",jsonFormat:"title,tags,categories,url,date",template:'<li><article><a href="{url}"><span class="entry-category">{categories}</span> {title} <span class="entry-date"><time datetime="{date}">{date}</time></span></a></article></li>',searchResults:".search-results",limit:"10",noResults:"<p>Oh no! We didn't find anything :(</p>"},e),a=l.jsonFormat.split(","),o=[],s=this,i=c(l.searchResults);function r(){i.children().remove()}l.jsonFile.length&&i.length&&c.ajax({type:"GET",url:l.jsonFile,dataType:"json",success:function(e,t,n){o=e,s.keyup(function(e){c(this).val().length?function(e){r(),i.append(c(l.searchResultsTitle)),e.length?c.each(e,function(e,t){if(e<l.limit){var n=l.template;for(e=0;e<a.length;e++){var s=new RegExp("{"+a[e]+"}","g");n=n.replace(s,t[a[e]])}i.append(c(n))}}):i.append(l.noResults)}(function(n){var s=[];return c.each(o,function(e,t){for(e=0;e<a.length;e++)void 0!==t[a[e]]&&-1!==t[a[e]].toLowerCase().indexOf(n.toLowerCase())&&(s.push(t),e=a.length)}),s}(c(this).val())):r()})},error:function(e,t,n){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(t),console.log(n)}})}}(Zepto);
!function(e,t){"function"==typeof define&&define.amd?define([],t(e)):"object"==typeof exports?module.exports=t(e):e.smoothScroll=t(e)}("undefined"!=typeof global?global:this.window||this.global,function(m){"use strict";function g(e){return null===e?0:function(e){return Math.max(e.scrollHeight,e.offsetHeight,e.clientHeight)}(e)+e.offsetTop}var n,t,b,v,o={},r="querySelector"in document&&"addEventListener"in m,y={selector:"[data-scroll]",selectorHeader:"[data-scroll-header]",speed:500,easing:"easeInOutCubic",offset:0,updateURL:!0,callback:function(){}},O=function(){var n={},o=!1,e=0,t=arguments.length;"[object Boolean]"===Object.prototype.toString.call(arguments[0])&&(o=arguments[0],e++);for(var r=function(e){for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(o&&"[object Object]"===Object.prototype.toString.call(e[t])?n[t]=O(!0,n[t],e[t]):n[t]=e[t])};e<t;e++){r(arguments[e])}return n};o.animateScroll=function(r,a,e){var t=function(e){return e&&"object"==typeof JSON&&"function"==typeof JSON.parse?JSON.parse(e):{}}(r?r.getAttribute("data-options"):null),c=O(c||y,e||{},t),u="#"===(a="#"+function(e){for(var t,n=String(e),o=n.length,r=-1,a="",c=n.charCodeAt(0);++r<o;){if(0===(t=n.charCodeAt(r)))throw new InvalidCharacterError("Invalid character: the input contains U+0000.");1<=t&&t<=31||127==t||0===r&&48<=t&&t<=57||1===r&&48<=t&&t<=57&&45===c?a+="\\"+t.toString(16)+" ":a+=128<=t||45===t||95===t||48<=t&&t<=57||65<=t&&t<=90||97<=t&&t<=122?n.charAt(r):"\\"+n.charAt(r)}return a}(a.substr(1)))?m.document.documentElement:m.document.querySelector(a),n=m.pageYOffset;b=b||m.document.querySelector(c.selectorHeader),v=v||g(b);var o,i,s,l=function(e,t,n){var o=0;if(e.offsetParent)for(;o+=e.offsetTop,e=e.offsetParent;);return 0<=(o=o-t-n)?o:0}(u,v,parseInt(c.offset,10)),f=l-n,d=Math.max(m.document.body.scrollHeight,m.document.documentElement.scrollHeight,m.document.body.offsetHeight,m.document.documentElement.offsetHeight,m.document.body.clientHeight,m.document.documentElement.clientHeight),h=0;!function(e,t){m.history.pushState&&(t||"true"===t)&&"file:"!==m.location.protocol&&m.history.pushState(null,null,[m.location.protocol,"//",m.location.host,m.location.pathname,m.location.search,e].join(""))}(a,c.updateURL);function p(){i=1<(i=(h+=16)/parseInt(c.speed,10))?1:i,s=n+f*function(e,t){var n;return"easeInQuad"===e&&(n=t*t),"easeOutQuad"===e&&(n=t*(2-t)),"easeInOutQuad"===e&&(n=t<.5?2*t*t:(4-2*t)*t-1),"easeInCubic"===e&&(n=t*t*t),"easeOutCubic"===e&&(n=--t*t*t+1),"easeInOutCubic"===e&&(n=t<.5?4*t*t*t:(t-1)*(2*t-2)*(2*t-2)+1),"easeInQuart"===e&&(n=t*t*t*t),"easeOutQuart"===e&&(n=1- --t*t*t*t),"easeInOutQuart"===e&&(n=t<.5?8*t*t*t*t:1-8*--t*t*t*t),"easeInQuint"===e&&(n=t*t*t*t*t),"easeOutQuint"===e&&(n=1+--t*t*t*t*t),"easeInOutQuint"===e&&(n=t<.5?16*t*t*t*t*t:1+16*--t*t*t*t*t),n||t}(c.easing,i),m.scrollTo(0,Math.floor(s)),function(e,t,n){var o=m.pageYOffset;(e==t||o==t||m.innerHeight+o>=d)&&(clearInterval(n),u.focus(),c.callback(r,a))}(s,l,o)}0===m.pageYOffset&&m.scrollTo(0,0),o=setInterval(p,16)};function a(e){var t=function(e,t){var n,o,r=t.charAt(0),a="classList"in document.documentElement;for("["===r&&1<(n=(t=t.substr(1,t.length-2)).split("=")).length&&(o=!0,n[1]=n[1].replace(/"/g,"").replace(/'/g,""));e&&e!==document;e=e.parentNode){if("."===r)if(a){if(e.classList.contains(t.substr(1)))return e}else if(new RegExp("(^|\\s)"+t.substr(1)+"(\\s|$)").test(e.className))return e;if("#"===r&&e.id===t.substr(1))return e;if("["===r&&e.hasAttribute(n[0])){if(!o)return e;if(e.getAttribute(n[0])===n[1])return e}if(e.tagName.toLowerCase()===t)return e}return null}(e.target,n.selector);t&&"a"===t.tagName.toLowerCase()&&(e.preventDefault(),o.animateScroll(t,t.hash,n))}function c(e){t=t||setTimeout(function(){t=null,v=g(b)},66)}return o.destroy=function(){n&&(m.document.removeEventListener("click",a,!1),m.removeEventListener("resize",c,!1),v=b=t=n=null)},o.init=function(e){r&&(o.destroy(),n=O(y,e||{}),b=m.document.querySelector(n.selectorHeader),v=g(b),m.document.addEventListener("click",a,!1),b&&m.addEventListener("resize",c,!1))},o});
!function(){for(var n=document.links,o=0,t=n.length;o<t;o++)n[o].hostname!=window.location.hostname&&(n[o].target="_blank")}();
!function(){"use strict";var t=document.querySelector(".post-content"),m=document.querySelector(".time-bar"),v=!0;if(t&&m){var p=0,y=t.scrollHeight,g=m.querySelector(".completed"),E=m.querySelector(".remaining"),f=m.querySelector(".time-completed"),h=m.querySelector(".time-remaining");document.addEventListener("scroll",function(){var t=window.pageYOffset||document.documentElement.scrollTop;if(m.style.bottom=p<t&&v?"0%":"-100%",t<=y){var e=t/y,n=(100*e).toFixed(2),r=100-parseFloat(n);g.style.width=n.toString()+"%",E.style.width=r.toString()+"%";var i=60*parseInt(m.getAttribute("data-minutes")),o=parseInt(e*i),a=parseInt(o/60),s=parseInt(60*(o/60-a)),c=i-o,u=parseInt(c/60),d=parseInt(60*(c/60-u));a=a<10?"0"+a:a,s=s<10?"0"+s:s,u=u<10?"0"+u:u,d=d<10?"0"+d:d,f.innerText=a+":"+s,h.innerText=u+":"+d,v=!0,function(){var t=document.createEvent("CustomEvent");t.initCustomEvent("stillReading"),document.dispatchEvent(t)}()}else{g.style.width="100%",E.style.width="0%";var l=parseInt(m.getAttribute("data-minutes"));l=l<10?"0"+l:l,f.innerText="00:00",h.innerText=l+":00",v=!1,function(){var t=document.createEvent("CustomEvent");t.initCustomEvent("finishedReading"),document.dispatchEvent(t)}()}p=t})}}();
!function(o){o("#menu").click(function(){o("body").addClass("push-menu-to-right"),o("#sidebar").addClass("open"),o(".overlay").addClass("show")}),o("#mask").click(function(){o("body").removeClass("push-menu-to-right"),o("#sidebar").removeClass("open"),o(".overlay").removeClass("show")});var e=o(".modal .close");e.on("click",function(){e.parent().parent().addClass("closed")});var a=o(".modal.exit");a.length&&ouibounce(a[0],{aggressive:!0,callback:function(){a.find(".close").on("click",function(){a.hide()})}});var s={close:o(".icon-remove-sign"),searchform:o(".search-form"),canvas:o("body"),dothis:o(".dosearch")};function c(){o(".search-wrapper").toggleClass("active"),s.searchform.toggleClass("active"),s.canvas.removeClass("search-overlay")}s.dothis.on("click",function(){o(".search-wrapper").toggleClass("active"),s.searchform.toggleClass("active"),s.searchform.find("input").focus(),s.canvas.toggleClass("search-overlay"),o(".search-field").simpleJekyllSearch()}),s.close.on("click",c),document.addEventListener("keyup",function(e){27==e.keyCode&&o(".search-overlay").length&&c()}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);
